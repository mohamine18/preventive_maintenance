...
exports.statusRegister = catchAsync(async (req, res) => {
  ...
  const newStatus = new Status({
    ...
    antivirusUpdate: req.body.antivirusUpdate,
    antivirusLicense: req.body.antivirusLicense,
    diskStatus: req.body.diskStatus,
    chkdsk: req.body.chkdsk,
    fragmentation: req.body.fragmentation,
    sfc: req.body.sfc,
    networkState: req.body.networkState,
    windowsLicense: req.body.windowsLicense,
    officeLicense: req.body.officeLicense,
    WindowsRestorePoint: req.body.WindowsRestorePoint,
    ProductionSoftware: req.body.ProductionSoftware,
    ShareAndBackup: req.body.ShareAndBackup,
